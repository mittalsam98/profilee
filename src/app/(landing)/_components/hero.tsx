...
export default function Hero() {
  return (
    <div className='px-4'>
      <div className='animate-slidein opacity-0 [--slidein-delay:200ms] flex flex-col items-center justify-center'>
        <div className='card-wrapper h-[41px] md:h-[50px] w-[280px] md:w-[340px] bg-gray-200'>
      ...
      <div className='animate-slidein opacity-0 [--slidein-delay:350ms] my-8 max-w-xl text-center mx-auto'>
      ...
      <div className='animate-slidein opacity-0 [--slidein-delay:500ms] mt-5 max-w-2xl text-center mx-auto'>
      ...
      <div className='animate-slidein opacity-0 [--slidein-delay:650ms] mt-8 gap-3 flex justify-center'>
        <Link
